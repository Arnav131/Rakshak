...
# Fails CLOSED: an unset DEBUG variable disables debug mode instead of
# leaking settings/SQL traces in production. Local development keeps
# DEBUG=True explicitly via .env.
